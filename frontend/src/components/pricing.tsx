...
const demoPrices = [
   
   {
      id: 'price_2',
      name: 'Premium',
      description: 'A premium plan for ',
      features: [
   ...
   return (
      <section id="pricing">
         <div className="mx-auto flex max-w-screen-xl flex-col gap-8 px-4 py-14 md:px-8">
            ...
            <div className="mx-auto w-full flex flex-row justify-center gap-4  ">
               {demoPrices.map((price, idx) => (
                  <div
                     key={price.id}
                     className={ny(
                        'relative flex w-[400px] flex-col gap-8 overflow-hidden rounded-2xl border p-4 text-black dark:text-white',
                        {
